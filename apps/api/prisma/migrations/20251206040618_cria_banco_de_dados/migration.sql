-- CreateEnum
CREATE TYPE "TokenType" AS ENUM ('PASSORD_RECOVER', 'INVITE');

-- CreateEnum
CREATE TYPE "AccountProvider" AS ENUM ('GITHUB', 'GMAIL', 'OUTLOOK');

-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'MEMBER', 'BILLING');

-- CreateEnum
CREATE TYPE "ProjectAndStepStatus" AS ENUM ('IN_PROGRESS', 'STOPPED', 'COMPLETED', 'WAITING');
...
CREATE TABLE "projectSteps" (
    ...
    CONSTRAINT "projectSteps_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "members" ADD CONSTRAINT "members_departament_id_fkey" FOREIGN KEY ("departament_id") REFERENCES "departaments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "projectSteps" ADD CONSTRAINT "projectSteps_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
